    ...
    return (
      <div className="container px-5 py-5 mx-auto">
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
          <div className="sm:w-22 sm:h-22 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-gray-900 text-indigo-500 flex-shrink-0">
            <svg
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
          ...
          <div className="sm:w-22 sm:order-none order-first sm:h-22 h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full bg-emerald-400 text-indigo-500 flex-shrink-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="60"
        ...
        <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
          <div className="sm:w-22 sm:h-22 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 87 70"
        ...
        <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
          ...
          <div className="sm:w-22 sm:order-none order-first sm:h-22 h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full bg-gray-100 text-indigo-500 flex-shrink-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              // xmlns:xlink="http://www.w3.org/1999/xlink"
              aria-hidden="true"
